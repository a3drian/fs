...
describe('a-json-data', () => {
    describe('getAJson', () => {
        ...
        const aJsonData = proxyquire('../src/data/a-json.data', {
            '../models/a-json.model': {
        ...
        it('should not contain key "nonExistingModelProp"', () => expect(theData.nonExistingModelProp).not.toBeDefined('theData contains key nonExistingModelProp'));
    });
});
//# sourceMappingURL=a-json.data.spec.js.map