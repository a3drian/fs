...
const discovery_client_route_1 = require("./routes/discovery-client.route");
const a_json_route_1 = require("./routes/a-json.route");
...
async function makeApp() {
    ...
    // routes
    app.use(env_1.env.DISCOVERY_CLIENT_ROUTE, discovery_client_route_1.setDiscoveryClientRoute(express_1.Router()));
    app.use(env_1.env.A_JSON_ROUTE, a_json_route_1.setAJsonRoute(express_1.Router()));
